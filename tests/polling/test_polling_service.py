...
@pytest.fixture
def mock_settings():
    with patch('hutch_bunny.core.polling.polling_service.get_settings') as mock_get_settings:
        mock_settings = Mock()
...
def test_poll_for_tasks_success(mock_settings, mock_client, mock_logger, mock_task_handler):
    # Arrange
...
def test_poll_for_tasks_no_task(mock_settings, mock_client, mock_logger, mock_task_handler):
    # Arrange
